...
namespace CarParkingBookingDatabase.BookingDBContext
{
    ...
    public class CarParkingBookingDBContext : DbContext
    {
        ...
        {
            byte[] byteArray = System.IO.File.ReadAllBytes(Path.Combine(AppDomain.CurrentDomain.BaseDirectory.Replace("\\CarParkingBooking\\bin\\Debug\\net8.0", ""), @".\CarParkingBookingDatabase\dummyData\OIP.jpg"));
            return byteArray;
        }
    }
}
